...
public class Ingreso {
    ...
    public static int datoEntero(String cMensaje, String cTitulo, int icono) {
        ...
        do {
            ...
            if (input == null) { // Verifica si el usuario canceló la entrada
                JOptionPane.showMessageDialog(null, "Entrada cancelada.", cTitulo, JOptionPane.INFORMATION_MESSAGE);
                return -1; // Retorna -1 para indicar que la entrada fue cancelada
            }
            try {
                numero = Integer.parseInt(input);
                valido = true;
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(null, "Error: Debe ingresar un número entero válido.", cTitulo,
